package com.raion.coinvest.presentation.screen.verivicationMentor
        ...
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
            Column (modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally)
            {
                ...
                Box(modifier = Modifier.fillMaxWidth()){
                    Column {
                        Text(text = "File berupa PDF atau PNG", modifier = Modifier.padding(start = 15.dp, end = 15.dp), color = Color.White)
                        Text(text = "File Maksimal 2MB", modifier = Modifier.padding(start = 15.dp, end = 15.dp), color = Color.White)
                    }
                }
