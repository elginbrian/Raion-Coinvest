package com.raion.coinvest.presentation.screen.communityProfileSection
        ...
        bottomBar = {
            Box(modifier = Modifier
                ...
                Column(modifier = Modifier) {
                    ...
                    Card(modifier = Modifier.fillMaxSize(),
                        ...
                        Scaffold(
                            ...
                            topBar = {
                                     Card(shape = RoundedCornerShape(topEnd = 16.dp, topStart = 16.dp),
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(text = "Community", fontSize = 10.sp)
                }
...
@Preview
fun CPSpreview(){
    CommunityProfileScreen(onChangeTab = {})
}