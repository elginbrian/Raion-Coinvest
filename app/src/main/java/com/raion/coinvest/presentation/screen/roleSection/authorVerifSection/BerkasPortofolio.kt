        ...
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                ...
                .padding(horizontal = 16.dp), verticalArrangement = Arrangement.SpaceBetween, horizontalAlignment = Alignment.CenterHorizontally)
            {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Image(painter = painterResource(id = R.drawable.num123_2), contentDescription = "", modifier = Modifier.fillMaxWidth(0.55f))
                    Spacer(modifier = Modifier.height(16.dp))
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ...
                        Text(text = "2) Tulis dengan format nama_portofolio.jpg", modifier = Modifier.padding(start = 15.dp, end = 15.dp), color = Color.White)
